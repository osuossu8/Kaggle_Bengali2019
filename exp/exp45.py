...
from src.trainer_bengali import train_one_epoch_mixup_cutmix, train_one_epoch_mixup_cutmix_for_single_output, validate_for_single_output, \
                                train_one_epoch_cutmix_for_single_output, train_one_epoch_mixup_for_single_output, validate_for_single_output_weighted
...
EXP_ID = "exp43_graph_split_over9000_gem_sum_conv_weight_75epoch_4e-4"
...
with timer('training loop'):
    ...
    for epoch in range(1, epochs + 1):
        ...
        if epochs - epoch > 5:
            flg = True
        tr_loss = train_one_epoch_mixup_for_single_output(model, train_loader, criterion, optimizer, device, flg=flg)
