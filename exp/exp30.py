...
EXP_ID = "exp30_keroppi_use_pretrain_prelu_mixup_cutmix_45epoch_4e-4"
...
batch_size_list = [12, 16, 24, 28, 32, 42, 64]
...
with timer('create model'):
    ...
    model = convert_model_ReLU2PReLU(model)
    model.conv1 = nn.Conv2d(1, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
    model.fc = nn.Linear(2048, 186)
