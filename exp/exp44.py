...
from src.layers import ResidualBlock, GeM, Mish, Swish
...
from src.resnet_model import resnet34, resnext50_32x4d
...
EXP_ID = "exp44_resnet34_mish_pretrain_cutmix_75epoch_1e-4"
...
batch_size_list = [36, 42, 48, 64, 70]


with timer('load csv data'):
    fold_id = 0
    epochs = 75
    batch_size = batch_size_list[4]
