...
from src.image_bengali import rand_bbox, cutmix, mixup, \
                              ...
                              cutmix_criterion_weighted2, mixup_criterion_weighted2                                    
...
def train_one_epoch_mixup_cutmix_for_single_swa(model, train_loader, criterion, optimizer, device, steps_upd_logging=500, accumulation_steps=1,
                                 multi_loss=None):
    model.train()
